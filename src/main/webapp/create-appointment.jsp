...
<body class="h-full overflow-hidden flex bg-clinic-50 text-clinic-900">
    ...
    <main class="flex-1 min-h-0 p-8 flex justify-center">
      <div class="w-full max-w-lg">
        ...
        <div class="bg-white rounded-2xl border border-clinic-100 shadow-sm p-7">
          <h1 class="font-display text-xl text-clinic-900 mb-1">Book an appointment</h1>
          <p class="text-sm text-clinic-700/70 mb-6">Find the patient, then pick a doctor, date and time.</p>
          ...
          <form id="createAppointmentForm" action="createAppointment" method="post" novalidate>
            ...
            <div class="mb-4">
              ...
              <p class="text-xs text-clinic-700/40 mt-1.5">Not in the system yet? <a href="createPatient" class="text-clinic-700 underline hover:text-clinic-900">Add them as a patient first</a>.</p>
            </div>
  ...
  <script>
    ...
    initAppointmentSlots({ doctorId: 'doctorId', dateId: 'appointmentDate', patientId: 'patientId', tagsContainerId: 'appointmentTimeTags' });
    initAppointmentFormValidation('createAppointmentForm');
