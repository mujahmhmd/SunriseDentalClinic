...
<head>
  ...
  <title>Create Service - Sunrise Dental</title>
...
<body class="h-full overflow-hidden flex bg-clinic-50 text-clinic-900">
  ...
  <div class="flex-1 flex flex-col min-w-0 min-h-0 h-screen overflow-y-auto">
    ...
    <jsp:include page="components/header.jsp">
      <jsp:param name="title" value="Create Service" />
    </jsp:include>
    ...
    <main class="flex-1 min-h-0 p-8 flex justify-center">
      <div class="w-full max-w-lg">
        ...
        <div class="bg-white rounded-2xl border border-clinic-100 shadow-sm p-7">
          <h1 class="font-display text-xl text-clinic-900 mb-1">Add a new service</h1>
          <p class="text-sm text-clinic-700/70 mb-6">This treatment will be available to attach to appointments once completed.</p>
          ...
          <form id="createServiceForm" action="createService" method="post" novalidate>
  ...
  <script>
    initServiceFormValidation('createServiceForm');
