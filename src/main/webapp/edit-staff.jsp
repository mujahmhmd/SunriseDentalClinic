    ...
    <main class="flex-1 min-h-0 p-8 flex justify-center">
      <div class="w-full max-w-lg">
        ...
        <div class="bg-white rounded-2xl border border-clinic-100 shadow-sm p-7">
          <h1 class="font-display text-xl text-clinic-900 mb-1">Edit staff member</h1>
          ...
          <form id="editStaffForm" action="editStaff" method="post" novalidate>
            <input type="hidden" id="staffId" name="id" value="<%= vId %>">
            ...
            <div class="mb-6">
              <label for="password" class="block text-sm font-medium text-clinic-900 mb-1.5">New Password</label>
              <div class="relative">
